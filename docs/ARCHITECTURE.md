...
- **run_crawler.py**: Pipeline automatizzata per l'acquisizione proattiva di documentazione da Archive.org e trasformazione in note Obsidian.
...
- **crawler.py**: Agente proattivo per la ricerca e acquisizione di nuova conoscenza dal web (Archive.org).
